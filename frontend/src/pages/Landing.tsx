...
import { 
  TrendingDown, Bell, BarChart3, Shield, Users, Sparkles,
  ArrowRight, Star, ChevronRight, Tag, Zap
} from 'lucide-react';
...
const features = [
  {
    ...
    description: 'Monitor prices across Amazon, Flipkart, Meesho, Myntra & Ajio in real-time.',
    color: 'bg-primary/10 text-primary',
  },
  {
    icon: BarChart3,
    title: 'Price History',
    description: 'View detailed price history charts to find the best time to buy.',
...
const stores = [
  { name: 'Amazon', emoji: '🛒', color: 'bg-orange-100 text-orange-600 border-orange-200' },
  { name: 'Flipkart', emoji: '🛍️', color: 'bg-blue-100 text-blue-600 border-blue-200' },
  { name: 'Meesho', emoji: '🎁', color: 'bg-pink-100 text-pink-600 border-pink-200' },
  { name: 'Myntra', emoji: '👗', color: 'bg-rose-100 text-rose-600 border-rose-200' },
  { name: 'Ajio', emoji: '👔', color: 'bg-amber-100 text-amber-600 border-amber-200' },
];
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Compare prices across Amazon, Flipkart, Meesho, Myntra & Ajio. 
              Get alerts when prices drop. Shop smart, save more.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <h2 className="text-3xl font-display font-bold">Hot deals right now</h2>
            </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {trendingProducts.map((product) => (
              <ProductCard 
                ...
                product={{
                  ...product,
                  buyRecommendation: product.buyRecommendation as 'good' | 'neutral' | 'high'
                }} 
                showActions={false} 
              />
            ))}
