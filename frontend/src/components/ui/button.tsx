  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-to-r from-primary to-accent text-primary-foreground hover:shadow-glow hover:-translate-y-1 font-semibold",
        success: "bg-success text-success-foreground hover:bg-success/90 hover:shadow-md",
        glass: "bg-card/60 backdrop-blur-md border border-border/50 hover:bg-card/80 hover:shadow-md",
      },
      size: {
